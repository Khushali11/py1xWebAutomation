...
#     LOGGER.critical("This is Critical Logs")logging Means - Capture details, Which are useful while debugging
# and show the user details about execution of program.
...
def test_print_logs():
    LOGGER = logging.getLogger(__name__)
    # Intentional Logging to User    LOGGER.info("This is information Logs")
    LOGGER.info("This is information Logs")
    LOGGER.warning("This is Warning Logs")
    LOGGER.error("This is Error Logs")
